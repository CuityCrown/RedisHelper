 ...
 *
 * @author 刘一博
 * @version RedisClusterUtils.java, v 0.1 2020年5月15日 10:51 刘一博 Exp $
 */
@Component
public class RedisClusterUtils {

    private final static Logger LOGGER = LoggerFactory.getLogger(RedisClusterUtils.class);
    ...
    private void init() {
        try {
            ...
            LOGGER.error("init RedisClusterUtils is failed", e);
        }
